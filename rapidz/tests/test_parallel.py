...
@pytest.mark.parametrize("backend", test_params)
@gen_test()
async def test_scan_state(backend):
    source = Stream(asynchronous=True)
...
@pytest.mark.parametrize("backend", test_params)
@gen_test()
async def test_starmap(backend):
    def add(x, y, z=0):
        return x + y + z
...
@pytest.mark.parametrize("backend", test_params)
@gen_test()
async def test_starmap_args(backend):
    def add(x, y, z=0):
        return x + y + z
...
@pytest.mark.parametrize("backend", test_params)
@gen_test()
async def test_buffer2(backend):
    source = Stream(asynchronous=True)
    futures = scatter(source, backend=backend)
    futures_L = futures.sink_to_list()
...
@pytest.mark.parametrize("backend", test_params)
@gen_test()
async def test_filter_buffer(backend):
    source = Stream(asynchronous=True)
    futures = scatter(source, backend=backend).filter(lambda x: x % 2 == 0)
    futures_L = futures.sink_to_list()
    L = futures.buffer(10).gather().sink_to_list()
...
@pytest.mark.parametrize("backend", test_params)
@gen_test()
async def test_filter_map(backend):
    source = Stream(asynchronous=True)
    futures = (
...
@pytest.mark.parametrize("backend", test_params)
@gen_test()
async def test_filter_starmap(backend):
    source = Stream(asynchronous=True)
...
@pytest.mark.parametrize("backend", test_params)
@gen_test()
async def test_filter_pluck(backend):
    source = Stream(asynchronous=True)
    futures1 = scatter(source, backend=backend).filter(lambda x: x[1] % 2 == 0)
...
@pytest.mark.parametrize("backend", test_params)
@gen_test()
async def test_filter_zip(backend):
    source = Stream(asynchronous=True)
...
@pytest.mark.parametrize("backend", test_params)
@gen_test()
async def test_double_scatter(backend):
...
@pytest.mark.parametrize("backend", test_params)
@gen_test
async def test_combined_latest(backend):
    def delay(x):
        time.sleep(.5)
        return x
