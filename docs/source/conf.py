...
# -*- coding: utf-8 -*-
#
# rapidz documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'rapidz.tex', 'rapidz Documentation',
...
man_pages = [
    (master_doc, 'rapidz', 'rapidz Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rapidz', 'rapidz Documentation',
     author, 'rapidz', 'One line description of project.',
     'Miscellaneous'),
]
